  ...
  return (
    <div className="about">
      ...
      <p className="about-description">
        Hi there! I’m Tejas, the creator of FitGenius. This app was born out of
        my passion for fitness and technology. I wanted to create a tool that
        could help people like you achieve their fitness goals with ease and
        personalisation.
      </p>
      <p className="about-description">
